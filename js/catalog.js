...
// ========================================================================
import { initCursorGlow, initTheme, initStarfield, makeThemeToggle } from "./effects.js?v=20260819d";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260819d";
import { iconSvg } from "./icons.js?v=20260819d";
...
function wirePdfButton() {
  ...
  btn.addEventListener("click", async () => {
    ...
    btn.disabled = true;
    try {
      const m = await import("./catalog-pdf.js?v=20260819d");
