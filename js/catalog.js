...
// ========================================================================
import { initCursorGlow, initTheme, initStarfield, makeThemeToggle } from "./effects.js?v=20260820i";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260820i";
import { iconSvg } from "./icons.js?v=20260820i";
...
function wirePdfButton() {
  ...
  btn.addEventListener("click", async () => {
    ...
    btn.disabled = true;
    try {
      const m = await import("./catalog-pdf.js?v=20260820i");
