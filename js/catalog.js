...
// ========================================================================
import { initCursorGlow, initTheme, initStarfield, makeThemeToggle } from "./effects.js?v=20260819e";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260819e";
import { iconSvg } from "./icons.js?v=20260819e";
...
function wirePdfButton() {
  ...
  btn.addEventListener("click", async () => {
    ...
    btn.disabled = true;
    try {
      const m = await import("./catalog-pdf.js?v=20260819e");
