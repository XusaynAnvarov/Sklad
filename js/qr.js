...
function placeFormat(M) {
  ...
  // Биты формата укладываются СТАРШИМ ВПЕРЁД: нулевым идёт бит 14, а не 0.
  // Раньше порядок был обратным — код выглядел правильно, но сканер не мог
  // разобрать сведения о формате и отбрасывал его целиком.
