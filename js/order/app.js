...
import { setLang, applyI18n } from "../i18n.js?v=20260921a";
import { кнопкаРазвернуть } from "../miniapp.js?v=20260921a";
import { мои, каталог, подпись } from "./api.js?v=20260921a";
import * as корзина from "./cart.js?v=20260921a";
...
const ЭКРАНЫ = {
  catalog: { title: "Каталог", mod: () => import("./screens/catalog.js?v=20260921a") },
  cart:    { title: "Корзина", mod: () => import("./screens/cart.js?v=20260921a") },
  orders:  { title: "Мои заказы", mod: () => import("./screens/myorders.js?v=20260921a") },
  // все оформленные накладные — в чате бота видны только последние десять
  invoices: { title: "Накладные", mod: () => import("./screens/invoices.js?v=20260921a") },
};
const ВКЛАДКИ = [
