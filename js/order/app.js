...
import { setLang, applyI18n } from "../i18n.js?v=20260914a";
import { кнопкаРазвернуть } from "../miniapp.js?v=20260914a";
import { мои, каталог, подпись } from "./api.js?v=20260914a";
import * as корзина from "./cart.js?v=20260914a";
...
const ЭКРАНЫ = {
  catalog: { title: "Каталог", mod: () => import("./screens/catalog.js?v=20260914a") },
  cart:    { title: "Корзина", mod: () => import("./screens/cart.js?v=20260914a") },
  orders:  { title: "Мои заказы", mod: () => import("./screens/myorders.js?v=20260914a") },
};
const ВКЛАДКИ = [
