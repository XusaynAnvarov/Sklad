...
// ========================================================================
import { el, toast, field, input } from "../ui.js?v=20260921a";
import { sendToClient } from "../telegram.js?v=20260921a";
import { statusOf, placeholder } from "./products.js?v=20260921a";
import { icon } from "../icons.js?v=20260921a";
import { thumb } from "../img.js?v=20260921a";
import { authHeaders } from "../db.js?v=20260921a";
import { естьКолонкаКода, раздел } from "../catalogcode.js?v=20260921a";
import { РАЗДЕЛЫ } from "../catalogbook-text.js?v=20260921a";
