...
// ========================================================================
import { el, toast, modal, confirmDialog, showLoader, hideLoader, input } from "../ui.js?v=20260819a";
import { icon } from "../icons.js?v=20260819a";
import { consumeFIFO, ensureBatches, sumQty, costAfter } from "../inventory.js?v=20260819a";
