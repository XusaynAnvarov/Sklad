...
// ========================================================================
import { el, toast, modal, confirmDialog, showLoader, hideLoader, input } from "../ui.js?v=20260826a";
import { icon } from "../icons.js?v=20260826a";
import { consumeFIFO, ensureBatches, sumQty, costAfter } from "../inventory.js?v=20260826a";
