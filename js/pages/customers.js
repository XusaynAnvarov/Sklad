...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260821c";
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260821c";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260821c";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260821c";
import { placeholder as placeholderImg } from "./products.js?v=20260821c";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260821c";
import { authHeaders } from "../db.js?v=20260821c";
import { icon } from "../icons.js?v=20260821c";
import { thumb } from "../img.js?v=20260821c";
import { methodOptions, methodText, DEFAULT_METHOD } from "../payment.js?v=20260821c";
// Расчёт долга общий со складом в телефоне — иначе цифры расходятся.
import { debtByCur, openingDebt, onlyPositive, coverageMap, issuedOnly } from "../debt.js?v=20260821c";
