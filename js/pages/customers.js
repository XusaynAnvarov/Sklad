...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260821g";
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260821g";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260821g";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260821g";
import { placeholder as placeholderImg } from "./products.js?v=20260821g";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260821g";
import { authHeaders } from "../db.js?v=20260821g";
import { icon } from "../icons.js?v=20260821g";
import { thumb } from "../img.js?v=20260821g";
import { methodOptions, methodText, DEFAULT_METHOD } from "../payment.js?v=20260821g";
// Расчёт долга общий со складом в телефоне — иначе цифры расходятся.
import { debtByCur, openingDebt, onlyPositive, coverageMap, issuedOnly } from "../debt.js?v=20260821g";
