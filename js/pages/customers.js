...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260829b";
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260829b";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260829b";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260829b";
import { placeholder as placeholderImg } from "./products.js?v=20260829b";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260829b";
import { authHeaders } from "../db.js?v=20260829b";
import { icon } from "../icons.js?v=20260829b";
import { thumb } from "../img.js?v=20260829b";
import { methodOptions, methodText, DEFAULT_METHOD } from "../payment.js?v=20260829b";
// Расчёт долга общий со складом в телефоне — иначе цифры расходятся.
import { debtByCur, openingDebt, onlyPositive, coverageMap, issuedOnly } from "../debt.js?v=20260829b";
