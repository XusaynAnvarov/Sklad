...
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260809a";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260809a";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260809a";
import { placeholder as placeholderImg } from "./products.js?v=20260809a";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260809a";
import { authHeaders } from "../db.js?v=20260809a";
