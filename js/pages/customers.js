...
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260902a";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260902a";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260902a";
import { placeholder as placeholderImg } from "./products.js?v=20260902a";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260902a";
import { authHeaders } from "../db.js?v=20260902a";
import { icon } from "../icons.js?v=20260902a";
import { thumb } from "../img.js?v=20260902a";
import { methodOptions, methodText, DEFAULT_METHOD } from "../payment.js?v=20260902a";
// Расчёт долга общий со складом в телефоне — иначе цифры расходятся.
import { debtByCur, openingDebt, onlyPositive, coverageMap, issuedOnly } from "../debt.js?v=20260902a";
