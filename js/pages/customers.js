...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260809b";
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260809b";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260809b";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260809b";
import { placeholder as placeholderImg } from "./products.js?v=20260809b";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260809b";
import { authHeaders } from "../db.js?v=20260809b";
