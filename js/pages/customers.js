...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260820a";
import { fmt, toUSD, convert, CUR, sumByCur } from "../fx.js?v=20260820a";
import { openEditor, buildText, deleteSale } from "./sales.js?v=20260820a";
import { exportCustomerInvoice } from "../xlsx-export.js?v=20260820a";
import { placeholder as placeholderImg } from "./products.js?v=20260820a";
import { sendInvoice, sendInvoicePDF, sendToClient, sendInvoicePDFToClient, sendActToClient, sendActToChannel, logoutClientFromBot } from "../telegram.js?v=20260820a";
import { authHeaders } from "../db.js?v=20260820a";
import { icon } from "../icons.js?v=20260820a";
import { thumb } from "../img.js?v=20260820a";
import { methodOptions, methodText, DEFAULT_METHOD } from "../payment.js?v=20260820a";
