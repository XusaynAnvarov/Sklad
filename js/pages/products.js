...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260926a";
import { icon } from "../icons.js?v=20260926a";
import { fmt, convert } from "../fx.js?v=20260926a";
import { consumeFIFO, ensureBatches, sumQty, currentCost, costOutlook } from "../inventory.js?v=20260926a";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260926a";
import { openEditor } from "./sales.js?v=20260926a";
import { thumbAttrs, thumb } from "../img.js?v=20260926a";
...
import { костСтрока as costShow, костВалюта, костПоля, ВАЛЮТЫ } from "../cost.js?v=20260926a";
...
import { ЕДИНИЦЫ, единица, вЕдинице, считаетсяПачками, подпись as подписьКол, перевести, объяснение } from "../unit.js?v=20260926a";
