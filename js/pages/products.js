...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox, showLoader, hideLoader } from "../ui.js?v=20260925b";
import { icon } from "../icons.js?v=20260925b";
import { fmt, convert } from "../fx.js?v=20260925b";
import { consumeFIFO, ensureBatches, sumQty, currentCost, costOutlook } from "../inventory.js?v=20260925b";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260925b";
import { openEditor } from "./sales.js?v=20260925b";
import { thumbAttrs, thumb } from "../img.js?v=20260925b";
...
import { костСтрока as costShow, костВалюта, костПоля, ВАЛЮТЫ } from "../cost.js?v=20260925b";
...
import { ЕДИНИЦЫ, единица, вЕдинице, считаетсяПачками, подпись as подписьКол, перевести, объяснение } from "../unit.js?v=20260925b";
