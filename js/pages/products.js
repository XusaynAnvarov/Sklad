...
import { fmt, convert } from "../fx.js?v=20260902b";
import { consumeFIFO, ensureBatches, sumQty, currentCost, costOutlook } from "../inventory.js?v=20260902b";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260902b";
import { openEditor } from "./sales.js?v=20260902b";
import { thumbAttrs, thumb } from "../img.js?v=20260902b";
import { LOW_STOCK } from "../advice.js?v=20260902b";
import { qrSvg, skuPayload } from "../qr.js?v=20260902b";
...
import { костСтрока as costShow, костВалюта, костПоля, ВАЛЮТЫ } from "../cost.js?v=20260902b";
...
import { ЕДИНИЦЫ, единица, вЕдинице, считаетсяПачками, подпись as подписьКол, перевести, объяснение } from "../unit.js?v=20260902b";
