...
import { fmt, convert } from "../fx.js?v=20260910a";
import { consumeFIFO, ensureBatches, sumQty, currentCost, costOutlook } from "../inventory.js?v=20260910a";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260910a";
import { openEditor } from "./sales.js?v=20260910a";
import { thumbAttrs, thumb } from "../img.js?v=20260910a";
import { LOW_STOCK } from "../advice.js?v=20260910a";
import { qrSvg, skuPayload } from "../qr.js?v=20260910a";
...
import { костСтрока as costShow, костВалюта, костПоля, ВАЛЮТЫ } from "../cost.js?v=20260910a";
...
import { ЕДИНИЦЫ, единица, вЕдинице, считаетсяПачками, подпись as подписьКол, перевести, объяснение } from "../unit.js?v=20260910a";
