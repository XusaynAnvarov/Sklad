...
import { consumeFIFO, ensureBatches, sumQty, currentCost, costOutlook } from "../inventory.js?v=20260915a";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260915a";
import { openEditor } from "./sales.js?v=20260915a";
import { thumbAttrs, thumb } from "../img.js?v=20260915a";
...
import { костСтрока as costShow, костВалюта, костПоля, ВАЛЮТЫ } from "../cost.js?v=20260915a";
...
import { ЕДИНИЦЫ, единица, вЕдинице, считаетсяПачками, подпись as подписьКол, перевести, объяснение } from "../unit.js?v=20260915a";
