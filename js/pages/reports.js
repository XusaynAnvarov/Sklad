...
// ========================================================================
import { el, modal, select } from "../ui.js?v=20260819c";
import { curStr, toUSD } from "../fx.js?v=20260819c";
import { SEASON_LABEL, SEASON_ICON, matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthShort, seasonOf } from "../period.js?v=20260819c";
import { loadRules, aggregate, itemRevenueUSD, itemProfitUSD, ruleFor, ruleText, ruleGroups } from "../profit.js?v=20260819c";
import { barChart, donutChart, hBars, seasonChart, miniSeason, noData } from "../charts.js?v=20260819c";
import { buildAdvice } from "../advice.js?v=20260819c";
import { placeholder } from "./products.js?v=20260819c";
import { icon } from "../icons.js?v=20260819c";
import { thumb } from "../img.js?v=20260819c";
import { byMethod, methodText } from "../payment.js?v=20260819c";
import { isShop } from "../purchase.js?v=20260819c";
