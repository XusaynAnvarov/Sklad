...
// ========================================================================
import { el, modal, select } from "../ui.js?v=20260819b";
import { curStr, toUSD } from "../fx.js?v=20260819b";
import { SEASON_LABEL, SEASON_ICON, matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthShort, seasonOf } from "../period.js?v=20260819b";
import { loadRules, aggregate, itemRevenueUSD, itemProfitUSD, ruleFor, ruleText, ruleGroups } from "../profit.js?v=20260819b";
import { barChart, donutChart, hBars, seasonChart, miniSeason, noData } from "../charts.js?v=20260819b";
...
import { byMethod, methodText } from "../payment.js?v=20260819b";
import { isShop } from "../purchase.js?v=20260819b";
