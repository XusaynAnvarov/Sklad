...
// ========================================================================
import { el, modal, select } from "../ui.js?v=20260902c";
import { curStr, toUSD } from "../fx.js?v=20260902c";
import { SEASON_LABEL, SEASON_ICON, matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthShort, seasonOf } from "../period.js?v=20260902c";
import { loadRules, aggregate, itemRevenueUSD, itemProfitUSD, ruleFor, ruleText, ruleGroups } from "../profit.js?v=20260902c";
import { debtByCur, onlyPositive } from "../debt.js?v=20260902c";
import { barChart, donutChart, hBars, seasonChart, miniSeason, noData } from "../charts.js?v=20260902c";
...
import { byMethod, methodText } from "../payment.js?v=20260902c";
import { isShop } from "../purchase.js?v=20260902c";
