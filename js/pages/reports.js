...
// ========================================================================
import { el, modal, select } from "../ui.js?v=20260829d";
import { curStr, toUSD } from "../fx.js?v=20260829d";
import { SEASON_LABEL, SEASON_ICON, matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthShort, seasonOf } from "../period.js?v=20260829d";
import { loadRules, aggregate, itemRevenueUSD, itemProfitUSD, ruleFor, ruleText, ruleGroups } from "../profit.js?v=20260829d";
import { debtByCur, onlyPositive } from "../debt.js?v=20260829d";
import { barChart, donutChart, hBars, seasonChart, miniSeason, noData } from "../charts.js?v=20260829d";
...
import { byMethod, methodText } from "../payment.js?v=20260829d";
import { isShop } from "../purchase.js?v=20260829d";
