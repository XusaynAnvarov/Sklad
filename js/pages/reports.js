...
// ========================================================================
import { el, modal, select } from "../ui.js?v=20260826a";
import { curStr, toUSD } from "../fx.js?v=20260826a";
import { SEASON_LABEL, SEASON_ICON, matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthShort, seasonOf } from "../period.js?v=20260826a";
import { loadRules, aggregate, itemRevenueUSD, itemProfitUSD, ruleFor, ruleText, ruleGroups } from "../profit.js?v=20260826a";
import { debtByCur, onlyPositive } from "../debt.js?v=20260826a";
import { barChart, donutChart, hBars, seasonChart, miniSeason, noData } from "../charts.js?v=20260826a";
import { buildAdvice } from "../advice.js?v=20260826a";
import { placeholder } from "./products.js?v=20260826a";
import { icon } from "../icons.js?v=20260826a";
import { thumb } from "../img.js?v=20260826a";
import { byMethod, methodText } from "../payment.js?v=20260826a";
import { isShop } from "../purchase.js?v=20260826a";
