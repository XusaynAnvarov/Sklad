...
// ========================================================================
import { el, toast, field, input, select, inputList, confirmDialog, showLoader, hideLoader } from "../ui.js?v=20260821b";
import { fetchLiveRates, setRates, getRates } from "../fx.js?v=20260821b";
import { authHeaders } from "../db.js?v=20260821b";
import { loadRules, saveRules, DEFAULT_RULES, KIND_LABEL, MODE_LABEL } from "../profit.js?v=20260821b";
