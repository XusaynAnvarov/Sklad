...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox } from "../ui.js?v=20260914a";
import { fmt, convert, CUR, sumByCur, curStr } from "../fx.js?v=20260914a";
import { sendInvoice, sendInvoicePDF } from "../telegram.js?v=20260914a";
import { наПодтверждение, отправитьНакладную } from "../orderconfirm.js?v=20260914a";
import { suggestPrice, priceNote } from "../prices.js?v=20260914a";
import { списанные } from "../stockcheck.js?v=20260914a";
import { placeholder } from "./products.js?v=20260914a";
import { consumeFIFO, returnToStock, ensureBatches, sumQty, currentCost, costAfter } from "../inventory.js?v=20260914a";
import { icon } from "../icons.js?v=20260914a";
import { showLoader, hideLoader } from "../ui.js?v=20260914a";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260914a";
import { exportInvoice } from "../xlsx-export.js?v=20260914a";
import { showNotFound } from "./purchases.js?v=20260914a";
