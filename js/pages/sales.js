...
// ========================================================================
import { el, $, toast, modal, confirmDialog, field, input, select, inputList, lightbox } from "../ui.js?v=20260925c";
import { fmt, convert, CUR, sumByCur, curStr } from "../fx.js?v=20260925c";
import { sendInvoice, sendInvoicePDF } from "../telegram.js?v=20260925c";
import { наПодтверждение, отправитьНакладную } from "../orderconfirm.js?v=20260925c";
import { suggestPrice, priceNote } from "../prices.js?v=20260925c";
import { списанные } from "../stockcheck.js?v=20260925c";
import { placeholder } from "./products.js?v=20260925c";
import { consumeFIFO, returnToStock, ensureBatches, sumQty, currentCost, costAfter } from "../inventory.js?v=20260925c";
import { icon } from "../icons.js?v=20260925c";
import { showLoader, hideLoader } from "../ui.js?v=20260925c";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260925c";
import { exportInvoice } from "../xlsx-export.js?v=20260925c";
import { showNotFound } from "./purchases.js?v=20260925c";
import { thumb, поставитьСнимок } from "../img.js?v=20260925c";
