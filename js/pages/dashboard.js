...
// ========================================================================
import { el, animateCount, modal, input, toast, confirmDialog, select } from "../ui.js?v=20260901a";
import { fmt, convert, toUSD, CUR } from "../fx.js?v=20260901a";
import { statusOf, placeholder, openForm as openProductForm } from "./products.js?v=20260901a";
import { ensureBatches, sumQty, costOutlook } from "../inventory.js?v=20260901a";
import { sparkline } from "../charts.js?v=20260901a";
import { debtByCur, onlyPositive } from "../debt.js?v=20260901a";
import { icon } from "../icons.js?v=20260901a";
import { openStockFix, unappliedSales } from "./stock_fix.js?v=20260901a";
import { matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthLabel } from "../period.js?v=20260901a";
import { loadRules, saveRules, aggregate, itemRevenueUSD, itemProfitUSD, itemRealProfitUSD, ruleGroups } from "../profit.js?v=20260901a";
import { buildAdvice } from "../advice.js?v=20260901a";
