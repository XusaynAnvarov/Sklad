...
// ========================================================================
import { el, animateCount, modal, input, toast, confirmDialog, select } from "../ui.js?v=20260824a";
import { fmt, convert, toUSD, CUR } from "../fx.js?v=20260824a";
import { statusOf, placeholder, openForm as openProductForm } from "./products.js?v=20260824a";
import { ensureBatches, sumQty, costOutlook } from "../inventory.js?v=20260824a";
import { sparkline } from "../charts.js?v=20260824a";
import { debtByCur, onlyPositive } from "../debt.js?v=20260824a";
import { icon } from "../icons.js?v=20260824a";
import { openStockFix, unappliedSales } from "./stock_fix.js?v=20260824a";
import { matchPeriod, buildPeriodOptions, monthsWithData, monthKey, monthLabel } from "../period.js?v=20260824a";
import { loadRules, saveRules, aggregate, itemRevenueUSD, itemProfitUSD, itemRealProfitUSD, ruleGroups } from "../profit.js?v=20260824a";
import { buildAdvice } from "../advice.js?v=20260824a";
import { thumb } from "../img.js?v=20260824a";
