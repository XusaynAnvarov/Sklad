...
import { fmt, CUR, convert } from "../fx.js?v=20260822c";
import { placeholder } from "./products.js?v=20260822c";
import { consumeFIFO, ensureBatches, sumQty, currentCost, costAfter } from "../inventory.js?v=20260822c";
import { icon } from "../icons.js?v=20260822c";
import { downloadTemplate, parseRows, pickFile } from "../xlsx-import.js?v=20260822c";
import { notifyOwner } from "../telegram.js?v=20260822c";
import { authHeaders } from "../db.js?v=20260822c";
import { thumb } from "../img.js?v=20260822c";
import { KIND_SHOP, purchaseKind, isShop, kindOptions, kindText, kindWho } from "../purchase.js?v=20260822c";
