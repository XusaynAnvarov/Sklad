...
import { isLoggedIn, clearToken as _clearToken, api } from "./api.js?v=20260821b";
import { renderCatalog } from "./catalog.js?v=20260821b";
import { renderVideos } from "./videos.js?v=20260821b";
import { renderCabinet } from "./cabinet.js?v=20260821b";
import { renderAdminPanel } from "./admin-panel.js?v=20260821b";
import { renderOrder } from "./order.js?v=20260821b";
import { setAuthChangeCallback, openLogin, logout as _logout, pendingAuth, clearPendingAuth } from "./auth.js?v=20260821b";
...
function renderCartDrawerContent() {
  ...
  if (cart.length) {
    ...
    orderBtn.addEventListener("click", async () => {
      ...
      try {
        const { api: siteApi } = await import("./api.js?v=20260821b");
