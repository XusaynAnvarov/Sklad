...
import { isLoggedIn, clearToken as _clearToken, api } from "./api.js?v=20260819b";
import { renderCatalog } from "./catalog.js?v=20260819b";
import { renderVideos } from "./videos.js?v=20260819b";
import { renderCabinet } from "./cabinet.js?v=20260819b";
import { renderAdminPanel } from "./admin-panel.js?v=20260819b";
import { renderOrder } from "./order.js?v=20260819b";
import { setAuthChangeCallback, openLogin, logout as _logout, pendingAuth, clearPendingAuth } from "./auth.js?v=20260819b";
...
function renderCartDrawerContent() {
  ...
  if (cart.length) {
    ...
    orderBtn.addEventListener("click", async () => {
      ...
      try {
        const { api: siteApi } = await import("./api.js?v=20260819b");
