...
import { isLoggedIn, clearToken as _clearToken, api } from "./api.js?v=20260821j";
import { renderCatalog } from "./catalog.js?v=20260821j";
import { renderVideos } from "./videos.js?v=20260821j";
import { renderCabinet } from "./cabinet.js?v=20260821j";
import { renderAdminPanel } from "./admin-panel.js?v=20260821j";
import { renderOrder } from "./order.js?v=20260821j";
import { setAuthChangeCallback, openLogin, logout as _logout, pendingAuth, clearPendingAuth } from "./auth.js?v=20260821j";
...
function renderCartDrawerContent() {
  ...
  if (cart.length) {
    ...
    orderBtn.addEventListener("click", async () => {
      ...
      try {
        const { api: siteApi } = await import("./api.js?v=20260821j");
