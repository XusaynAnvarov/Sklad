...
import { isLoggedIn, clearToken as _clearToken, api } from "./api.js?v=20260803f";
import { renderCatalog } from "./catalog.js?v=20260803f";
import { renderVideos } from "./videos.js?v=20260803f";
import { renderCabinet } from "./cabinet.js?v=20260803f";
import { renderAdminPanel } from "./admin-panel.js?v=20260803f";
import { renderOrder } from "./order.js?v=20260803f";
import { setAuthChangeCallback, openLogin, logout as _logout } from "./auth.js?v=20260803f";
...
function renderCartDrawerContent() {
  ...
  if (cart.length) {
    ...
    orderBtn.addEventListener("click", async () => {
      ...
      try {
        const { api: siteApi } = await import("./api.js?v=20260803f");
