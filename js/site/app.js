...
import { isLoggedIn, clearToken as _clearToken, api } from "./api.js?v=20260803e";
import { renderCatalog } from "./catalog.js?v=20260803e";
import { renderVideos } from "./videos.js?v=20260803e";
import { renderCabinet } from "./cabinet.js?v=20260803e";
import { renderAdminPanel } from "./admin-panel.js?v=20260803e";
import { renderOrder } from "./order.js?v=20260803e";
import { setAuthChangeCallback, openLogin, logout as _logout } from "./auth.js?v=20260803e";
...
function renderCartDrawerContent() {
  ...
  if (cart.length) {
    ...
    orderBtn.addEventListener("click", async () => {
      ...
      try {
        const { api: siteApi } = await import("./api.js?v=20260803e");
