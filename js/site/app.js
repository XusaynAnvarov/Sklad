...
import { isLoggedIn, clearToken as _clearToken, api } from "./api.js?v=20260829d";
import { renderCatalog } from "./catalog.js?v=20260829d";
import { renderVideos } from "./videos.js?v=20260829d";
import { renderCabinet } from "./cabinet.js?v=20260829d";
import { renderAdminPanel } from "./admin-panel.js?v=20260829d";
import { renderOrder } from "./order.js?v=20260829d";
import { setAuthChangeCallback, openLogin, logout as _logout, pendingAuth, clearPendingAuth } from "./auth.js?v=20260829d";
...
function renderCartDrawerContent() {
  ...
  if (cart.length) {
    ...
    orderBtn.addEventListener("click", async () => {
      ...
      try {
        const { api: siteApi } = await import("./api.js?v=20260829d");
