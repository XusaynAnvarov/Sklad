...
// ========================================================================
import { el, $, reveal, showLoader, hideLoader, toast } from "./ui.js?v=20260902b";
import { обновитьЕслиУстарело } from "./version.js?v=20260902b";
import { icon } from "./icons.js?v=20260902b";
import { db, rawClient } from "./db.js?v=20260902b";
import { ensureAccess, alreadyAuthed, logout } from "./auth.js?v=20260902b";
import { setRates } from "./fx.js?v=20260902b";
// версия в импорте обязательна: без неё CDN отдаёт старый effects.js (там тема по умолчанию была светлой)
import { initTheme, initCursorGlow, initStarfield, makeThemeToggle } from "./effects.js?v=20260902b";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260902b";

import dashboard from "./pages/dashboard.js?v=20260902b";
import products from "./pages/products.js?v=20260902b";
import sales from "./pages/sales.js?v=20260902b";
import purchases from "./pages/purchases.js?v=20260902b";
import customers from "./pages/customers.js?v=20260902b";
import orders from "./pages/orders.js?v=20260902b";
import reports from "./pages/reports.js?v=20260902b";
import catalogPage from "./pages/catalog_admin.js?v=20260902b";
import settings from "./pages/settings.js?v=20260902b";
import siteClients from "./pages/site_clients.js?v=20260902b";
import trash from "./pages/trash.js?v=20260902b";
import videosAdmin from "./pages/videos_admin.js?v=20260902b";
import supplierOrder from "./pages/supplier_order.js?v=20260902b";
import stockCheck from "./pages/stock_check.js?v=20260902b";
