...
// ========================================================================
import { el, $, reveal, showLoader, hideLoader } from "./ui.js?v=20260809a";
import { icon } from "./icons.js?v=20260809a";
import { db, rawClient } from "./db.js?v=20260809a";
import { ensureAccess, alreadyAuthed, logout } from "./auth.js?v=20260809a";
import { setRates } from "./fx.js?v=20260809a";
// версия в импорте обязательна: без неё CDN отдаёт старый effects.js (там тема по умолчанию была светлой)
import { initTheme, initCursorGlow, initStarfield, makeThemeToggle } from "./effects.js?v=20260809a";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260809a";

import dashboard from "./pages/dashboard.js?v=20260809a";
import products from "./pages/products.js?v=20260809a";
import sales from "./pages/sales.js?v=20260809a";
import purchases from "./pages/purchases.js?v=20260809a";
import customers from "./pages/customers.js?v=20260809a";
import orders from "./pages/orders.js?v=20260809a";
import reports from "./pages/reports.js?v=20260809a";
import catalogPage from "./pages/catalog_admin.js?v=20260809a";
import settings from "./pages/settings.js?v=20260809a";
import siteClients from "./pages/site_clients.js?v=20260809a";
import trash from "./pages/trash.js?v=20260809a";
import videosAdmin from "./pages/videos_admin.js?v=20260809a";
import supplierOrder from "./pages/supplier_order.js?v=20260809a";
import stockCheck from "./pages/stock_check.js?v=20260809a";
