...
// ========================================================================
import { el, $, reveal, showLoader, hideLoader } from "./ui.js?v=20260821d";
import { icon } from "./icons.js?v=20260821d";
import { db, rawClient } from "./db.js?v=20260821d";
import { ensureAccess, alreadyAuthed, logout } from "./auth.js?v=20260821d";
...
import { initTheme, initCursorGlow, initStarfield, makeThemeToggle } from "./effects.js?v=20260821d";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260821d";

import dashboard from "./pages/dashboard.js?v=20260821d";
import products from "./pages/products.js?v=20260821d";
import sales from "./pages/sales.js?v=20260821d";
import purchases from "./pages/purchases.js?v=20260821d";
import customers from "./pages/customers.js?v=20260821d";
import orders from "./pages/orders.js?v=20260821d";
import reports from "./pages/reports.js?v=20260821d";
import catalogPage from "./pages/catalog_admin.js?v=20260821d";
import settings from "./pages/settings.js?v=20260821d";
import siteClients from "./pages/site_clients.js?v=20260821d";
import trash from "./pages/trash.js?v=20260821d";
import videosAdmin from "./pages/videos_admin.js?v=20260821d";
import supplierOrder from "./pages/supplier_order.js?v=20260821d";
import stockCheck from "./pages/stock_check.js?v=20260821d";
...
if ("serviceWorker" in navigator && (location.protocol === "https:" || location.hostname === "localhost")) {
  window.addEventListener("load", () => navigator.serviceWorker.register("sw.js?v=131", { updateViaCache: "none" }).catch(() => {}));
