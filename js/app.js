...
// ========================================================================
import { el, $, reveal, showLoader, hideLoader } from "./ui.js?v=20260821b";
import { icon } from "./icons.js?v=20260821b";
import { db, rawClient } from "./db.js?v=20260821b";
import { ensureAccess, alreadyAuthed, logout } from "./auth.js?v=20260821b";
import { setRates } from "./fx.js?v=20260821b";
// версия в импорте обязательна: без неё CDN отдаёт старый effects.js (там тема по умолчанию была светлой)
import { initTheme, initCursorGlow, initStarfield, makeThemeToggle } from "./effects.js?v=20260821b";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260821b";

import dashboard from "./pages/dashboard.js?v=20260821b";
import products from "./pages/products.js?v=20260821b";
import sales from "./pages/sales.js?v=20260821b";
import purchases from "./pages/purchases.js?v=20260821b";
import customers from "./pages/customers.js?v=20260821b";
import orders from "./pages/orders.js?v=20260821b";
import reports from "./pages/reports.js?v=20260821b";
import catalogPage from "./pages/catalog_admin.js?v=20260821b";
import settings from "./pages/settings.js?v=20260821b";
import siteClients from "./pages/site_clients.js?v=20260821b";
import trash from "./pages/trash.js?v=20260821b";
import videosAdmin from "./pages/videos_admin.js?v=20260821b";
import supplierOrder from "./pages/supplier_order.js?v=20260821b";
import stockCheck from "./pages/stock_check.js?v=20260821b";
...
if ("serviceWorker" in navigator && (location.protocol === "https:" || location.hostname === "localhost")) {
  window.addEventListener("load", () => navigator.serviceWorker.register("sw.js?v=129", { updateViaCache: "none" }).catch(() => {}));
