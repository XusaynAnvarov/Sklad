...
// ========================================================================
import { el, $, reveal, showLoader, hideLoader } from "./ui.js?v=20260821e";
import { icon } from "./icons.js?v=20260821e";
import { db, rawClient } from "./db.js?v=20260821e";
import { ensureAccess, alreadyAuthed, logout } from "./auth.js?v=20260821e";
...
import { initTheme, initCursorGlow, initStarfield, makeThemeToggle } from "./effects.js?v=20260821e";
import { applyI18n, makeLangSwitcher } from "./i18n.js?v=20260821e";

import dashboard from "./pages/dashboard.js?v=20260821e";
import products from "./pages/products.js?v=20260821e";
import sales from "./pages/sales.js?v=20260821e";
import purchases from "./pages/purchases.js?v=20260821e";
import customers from "./pages/customers.js?v=20260821e";
import orders from "./pages/orders.js?v=20260821e";
import reports from "./pages/reports.js?v=20260821e";
import catalogPage from "./pages/catalog_admin.js?v=20260821e";
import settings from "./pages/settings.js?v=20260821e";
import siteClients from "./pages/site_clients.js?v=20260821e";
import trash from "./pages/trash.js?v=20260821e";
import videosAdmin from "./pages/videos_admin.js?v=20260821e";
import supplierOrder from "./pages/supplier_order.js?v=20260821e";
import stockCheck from "./pages/stock_check.js?v=20260821e";
...
if ("serviceWorker" in navigator && (location.protocol === "https:" || location.hostname === "localhost")) {
  window.addEventListener("load", () => navigator.serviceWorker.register("sw.js?v=132", { updateViaCache: "none" }).catch(() => {}));
