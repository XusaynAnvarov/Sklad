...
// ========================================================================
import { db } from "../db.js?v=20260902c";
...
import { toast } from "../ui.js?v=20260902c";
import { кнопкаРазвернуть } from "../miniapp.js?v=20260902c";
...
// склада продолжали брать его отсюда: import { el } from "../app.js?v=20260902c".
export { el };
...
// ---------- экраны ----------
const SCREENS = {
  home:      { title: "Склад",              mod: () => import("./screens/home.js?v=20260902c") },
  products:  { title: "Товары",             mod: () => import("./screens/products.js?v=20260902c") },
  sale:      { title: "Продажа",            mod: () => import("./screens/sale.js?v=20260902c") },
  report:    { title: "Отчёт",              mod: () => import("./screens/report.js?v=20260902c") },
  labels:    { title: "Наклейки",           mod: () => import("./screens/labels.js?v=20260902c") },
  clients:   { title: "Клиенты",            mod: () => import("./screens/clients.js?v=20260902c") },
  arrival:   { title: "Приход из магазина", mod: () => import("./screens/arrival.js?v=20260902c") },
  docs:      { title: "Накладные и оплаты", mod: () => import("./screens/docs.js?v=20260902c") },
  more:      { title: "Ещё",                mod: () => import("./screens/more.js?v=20260902c") },
  orders:    { title: "Заказы",             mod: () => import("./screens/orders.js?v=20260902c") },
  purchases: { title: "Приход",             mod: () => import("./screens/purchases.js?v=20260902c") },
  check:     { title: "Проверка склада",    mod: () => import("./screens/check.js?v=20260902c") },
  trash:     { title: "Корзина",            mod: () => import("./screens/trash.js?v=20260902c") },
};
