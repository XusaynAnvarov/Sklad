...
// ========================================================================
import { db } from "../db.js?v=20260914b";
...
// склада продолжали брать его отсюда: import { el } from "../app.js?v=20260914b".
export { el };
...
// ---------- экраны ----------
const SCREENS = {
  home:      { title: "Склад",              mod: () => import("./screens/home.js?v=20260914b") },
  products:  { title: "Товары",             mod: () => import("./screens/products.js?v=20260914b") },
  sale:      { title: "Продажа",            mod: () => import("./screens/sale.js?v=20260914b") },
  report:    { title: "Отчёт",              mod: () => import("./screens/report.js?v=20260914b") },
  labels:    { title: "Наклейки",           mod: () => import("./screens/labels.js?v=20260914b") },
  clients:   { title: "Клиенты",            mod: () => import("./screens/clients.js?v=20260914b") },
  arrival:   { title: "Приход из магазина", mod: () => import("./screens/arrival.js?v=20260914b") },
  docs:      { title: "Накладные и оплаты", mod: () => import("./screens/docs.js?v=20260914b") },
  more:      { title: "Ещё",                mod: () => import("./screens/more.js?v=20260914b") },
  orders:    { title: "Заказы",             mod: () => import("./screens/orders.js?v=20260914b") },
  purchases: { title: "Приход",             mod: () => import("./screens/purchases.js?v=20260914b") },
  check:     { title: "Проверка склада",    mod: () => import("./screens/check.js?v=20260914b") },
  trash:     { title: "Корзина",            mod: () => import("./screens/trash.js?v=20260914b") },
};
