...
// ========================================================================
import { db } from "../db.js?v=20260826a";
...
import { toast } from "../ui.js?v=20260826a";
import { isDesktop } from "./qr.js?v=20260826a";
...
// ---------- экраны ----------
const SCREENS = {
  home:      { title: "Склад",              mod: () => import("./screens/home.js?v=20260826a") },
  products:  { title: "Товары",             mod: () => import("./screens/products.js?v=20260826a") },
  sale:      { title: "Продажа",            mod: () => import("./screens/sale.js?v=20260826a") },
  report:    { title: "Отчёт",              mod: () => import("./screens/report.js?v=20260826a") },
  labels:    { title: "Наклейки",           mod: () => import("./screens/labels.js?v=20260826a") },
  clients:   { title: "Клиенты",            mod: () => import("./screens/clients.js?v=20260826a") },
  arrival:   { title: "Приход из магазина", mod: () => import("./screens/arrival.js?v=20260826a") },
  docs:      { title: "Накладные и оплаты", mod: () => import("./screens/docs.js?v=20260826a") },
  more:      { title: "Ещё",                mod: () => import("./screens/more.js?v=20260826a") },
  orders:    { title: "Заказы",             mod: () => import("./screens/orders.js?v=20260826a") },
  purchases: { title: "Приход",             mod: () => import("./screens/purchases.js?v=20260826a") },
  check:     { title: "Проверка склада",    mod: () => import("./screens/check.js?v=20260826a") },
  trash:     { title: "Корзина",            mod: () => import("./screens/trash.js?v=20260826a") },
};
