...
// ========================================================================
import { db } from "../db.js?v=20260901c";
...
import { кнопкаРазвернуть } from "../miniapp.js?v=20260901c";
...
// склада продолжали брать его отсюда: import { el } from "../app.js?v=20260901c".
export { el };
...
// ---------- экраны ----------
const SCREENS = {
  home:      { title: "Склад",              mod: () => import("./screens/home.js?v=20260901c") },
  products:  { title: "Товары",             mod: () => import("./screens/products.js?v=20260901c") },
  sale:      { title: "Продажа",            mod: () => import("./screens/sale.js?v=20260901c") },
  report:    { title: "Отчёт",              mod: () => import("./screens/report.js?v=20260901c") },
  labels:    { title: "Наклейки",           mod: () => import("./screens/labels.js?v=20260901c") },
  clients:   { title: "Клиенты",            mod: () => import("./screens/clients.js?v=20260901c") },
  arrival:   { title: "Приход из магазина", mod: () => import("./screens/arrival.js?v=20260901c") },
  docs:      { title: "Накладные и оплаты", mod: () => import("./screens/docs.js?v=20260901c") },
  more:      { title: "Ещё",                mod: () => import("./screens/more.js?v=20260901c") },
  orders:    { title: "Заказы",             mod: () => import("./screens/orders.js?v=20260901c") },
  purchases: { title: "Приход",             mod: () => import("./screens/purchases.js?v=20260901c") },
  check:     { title: "Проверка склада",    mod: () => import("./screens/check.js?v=20260901c") },
  trash:     { title: "Корзина",            mod: () => import("./screens/trash.js?v=20260901c") },
};
