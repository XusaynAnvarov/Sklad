...
// ========================================================================
import { db } from "../db.js?v=20260821i";
import { setRates } from "../fx.js?v=20260821i";
import { icon } from "../icons.js?v=20260821i";
import { toast } from "../ui.js?v=20260821i";
import { isDesktop } from "./qr.js?v=20260821i";
...
// ---------- экраны ----------
const SCREENS = {
  home:      { title: "Склад",              mod: () => import("./screens/home.js?v=20260821i") },
  products:  { title: "Товары",             mod: () => import("./screens/products.js?v=20260821i") },
  sale:      { title: "Продажа",            mod: () => import("./screens/sale.js?v=20260821i") },
  report:    { title: "Отчёт",              mod: () => import("./screens/report.js?v=20260821i") },
  labels:    { title: "Наклейки",           mod: () => import("./screens/labels.js?v=20260821i") },
  clients:   { title: "Клиенты",            mod: () => import("./screens/clients.js?v=20260821i") },
  arrival:   { title: "Приход из магазина", mod: () => import("./screens/arrival.js?v=20260821i") },
  docs:      { title: "Накладные и оплаты", mod: () => import("./screens/docs.js?v=20260821i") },
  more:      { title: "Ещё",                mod: () => import("./screens/more.js?v=20260821i") },
  orders:    { title: "Заказы",             mod: () => import("./screens/orders.js?v=20260821i") },
  purchases: { title: "Приход",             mod: () => import("./screens/purchases.js?v=20260821i") },
  check:     { title: "Проверка склада",    mod: () => import("./screens/check.js?v=20260821i") },
  trash:     { title: "Корзина",            mod: () => import("./screens/trash.js?v=20260821i") },
};
