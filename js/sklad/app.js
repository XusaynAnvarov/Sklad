...
// ========================================================================
import { db } from "../db.js?v=20260822b";
...
import { toast } from "../ui.js?v=20260822b";
import { isDesktop } from "./qr.js?v=20260822b";
...
// ---------- экраны ----------
const SCREENS = {
  home:      { title: "Склад",              mod: () => import("./screens/home.js?v=20260822b") },
  products:  { title: "Товары",             mod: () => import("./screens/products.js?v=20260822b") },
  sale:      { title: "Продажа",            mod: () => import("./screens/sale.js?v=20260822b") },
  report:    { title: "Отчёт",              mod: () => import("./screens/report.js?v=20260822b") },
  labels:    { title: "Наклейки",           mod: () => import("./screens/labels.js?v=20260822b") },
  clients:   { title: "Клиенты",            mod: () => import("./screens/clients.js?v=20260822b") },
  arrival:   { title: "Приход из магазина", mod: () => import("./screens/arrival.js?v=20260822b") },
  docs:      { title: "Накладные и оплаты", mod: () => import("./screens/docs.js?v=20260822b") },
  more:      { title: "Ещё",                mod: () => import("./screens/more.js?v=20260822b") },
  orders:    { title: "Заказы",             mod: () => import("./screens/orders.js?v=20260822b") },
  purchases: { title: "Приход",             mod: () => import("./screens/purchases.js?v=20260822b") },
  check:     { title: "Проверка склада",    mod: () => import("./screens/check.js?v=20260822b") },
  trash:     { title: "Корзина",            mod: () => import("./screens/trash.js?v=20260822b") },
};
