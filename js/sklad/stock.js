...
//  занимала бы минуту.
// ========================================================================
import { consumeFIFO, returnToStock, ensureBatches, sumQty, costAfter, currentCost } from "../inventory.js?v=20260902c";
import { arrivalRows } from "../arrival.js?v=20260902c";
import { KIND_SHOP } from "../purchase.js?v=20260902c";
