...
//  занимала бы минуту.
// ========================================================================
import { consumeFIFO, returnToStock, ensureBatches, sumQty, costAfter, currentCost } from "../inventory.js?v=20260921a";
import { arrivalRows } from "../arrival.js?v=20260921a";
