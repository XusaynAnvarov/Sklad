...
//  занимала бы минуту.
// ========================================================================
import { consumeFIFO, returnToStock, ensureBatches, sumQty, costAfter, currentCost } from "../inventory.js?v=20260901a";
import { arrivalRows } from "../arrival.js?v=20260901a";
import { KIND_SHOP } from "../purchase.js?v=20260901a";
