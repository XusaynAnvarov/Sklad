...
import { el, go, VERSION, isGuest } from "../app.js?v=20260831b";
import { icon } from "../../icons.js?v=20260831b";
import { toast, modal } from "../../ui.js?v=20260831b";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260831b";
