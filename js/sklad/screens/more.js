...
import { el, go, VERSION, isGuest } from "../app.js?v=20260829d";
import { icon } from "../../icons.js?v=20260829d";
import { toast, modal } from "../../ui.js?v=20260829d";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260829d";
