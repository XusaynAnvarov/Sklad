...
import { el, go, VERSION, isGuest } from "../app.js?v=20260902c";
import { icon } from "../../icons.js?v=20260902c";
import { toast, modal } from "../../ui.js?v=20260902c";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260902c";
