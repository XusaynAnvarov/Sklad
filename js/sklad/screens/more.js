...
import { el, go, VERSION, isGuest } from "../app.js?v=20260901c";
import { icon } from "../../icons.js?v=20260901c";
import { toast, modal } from "../../ui.js?v=20260901c";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260901c";
