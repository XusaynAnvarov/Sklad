...
import { el, go, VERSION, isGuest } from "../app.js?v=20260921a";
import { icon } from "../../icons.js?v=20260921a";
import { toast, modal } from "../../ui.js?v=20260921a";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260921a";
