...
import { el, go, VERSION, isGuest } from "../app.js?v=20260910a";
import { icon } from "../../icons.js?v=20260910a";
import { toast, modal } from "../../ui.js?v=20260910a";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260910a";
