...
import { el, go, VERSION, isGuest } from "../app.js?v=20260910b";
import { icon } from "../../icons.js?v=20260910b";
import { toast, modal } from "../../ui.js?v=20260910b";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260910b";
