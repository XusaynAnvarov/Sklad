...
import { el, go, VERSION, isGuest } from "../app.js?v=20260821k";
import { icon } from "../../icons.js?v=20260821k";
import { toast, modal } from "../../ui.js?v=20260821k";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260821k";
