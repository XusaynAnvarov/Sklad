...
import { el, go, VERSION, isGuest } from "../app.js?v=20260914b";
import { icon } from "../../icons.js?v=20260914b";
import { toast, modal } from "../../ui.js?v=20260914b";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260914b";
