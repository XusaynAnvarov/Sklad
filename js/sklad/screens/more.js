...
import { el, go, VERSION, isGuest } from "../app.js?v=20260821f";
import { icon } from "../../icons.js?v=20260821f";
import { toast, modal } from "../../ui.js?v=20260821f";
import { собрать, скачать, имяФайла } from "../../backup.js?v=20260821f";
