...
import { el } from "../app.js?v=20260824a";
import { matchPeriod, buildPeriodOptions } from "../../period.js?v=20260824a";
import { byMethod, methodLabel } from "../../payment.js?v=20260824a";
import { isShop } from "../../purchase.js?v=20260824a";
import { curStr, convert } from "../../fx.js?v=20260824a";
import { loadRules, aggregate } from "../../profit.js?v=20260824a";
