...
import { el } from "../app.js?v=20260829d";
import { icon } from "../../icons.js?v=20260829d";
import { toast, modal, confirmDialog } from "../../ui.js?v=20260829d";
import { fmt } from "../../fx.js?v=20260829d";
import { methodOptions, DEFAULT_METHOD } from "../../payment.js?v=20260829d";
import { debtByCur, onlyPositive, turnoverByCur, hasDebt, coverageMap, openingDebt, issuedOnly, CURS, zero } from "../../debt.js?v=20260829d";
import { lastForCustomerMap, freshFirst } from "../../prices.js?v=20260829d";
