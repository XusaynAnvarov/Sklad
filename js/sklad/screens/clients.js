...
import { el } from "../app.js?v=20260910a";
import { icon } from "../../icons.js?v=20260910a";
import { toast, modal, confirmDialog } from "../../ui.js?v=20260910a";
import { fmt } from "../../fx.js?v=20260910a";
import { methodOptions, DEFAULT_METHOD } from "../../payment.js?v=20260910a";
import { debtByCur, onlyPositive, turnoverByCur, hasDebt, coverageMap, openingDebt, issuedOnly, CURS, zero } from "../../debt.js?v=20260910a";
import { lastForCustomerMap, freshFirst } from "../../prices.js?v=20260910a";
