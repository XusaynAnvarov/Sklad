...
import { ensureBatches, currentCost } from "../../inventory.js?v=20260902a";
import { receiveFromShop } from "../stock.js?v=20260902a";
import { scanSku, canScan, resolveScan, scanFailText } from "../qr.js?v=20260902a";
import { photoBlock } from "../photo.js?v=20260902a";
import { KIND_SHOP } from "../../purchase.js?v=20260902a";
