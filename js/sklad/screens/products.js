...
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260902c";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260902c";
import { fmt, convert } from "../../fx.js?v=20260902c";
import { thumb } from "../../img.js?v=20260902c";
import { LOW_STOCK } from "../../advice.js?v=20260902c";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260902c";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260902c";
import { подпись as подписьКол, единица, вЕдинице } from "../../unit.js?v=20260902c";
