...
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260925b";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260925b";
import { fmt, convert } from "../../fx.js?v=20260925b";
import { thumb } from "../../img.js?v=20260925b";
import { LOW_STOCK } from "../../advice.js?v=20260925b";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260925b";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260925b";
import { подпись as подписьКол, единица, вЕдинице } from "../../unit.js?v=20260925b";
import { подходит } from "../../productsearch.js?v=20260925b";
import { подписьКода, естьКолонкаКода, кодПриСохранении, следующийПосле, КОД_ЗАНЯТ } from "../../catalogcode.js?v=20260925b";
