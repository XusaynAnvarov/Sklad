...
import { el, go } from "../app.js?v=20260831b";
import { icon } from "../../icons.js?v=20260831b";
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260831b";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260831b";
import { fmt, convert } from "../../fx.js?v=20260831b";
import { thumb } from "../../img.js?v=20260831b";
import { LOW_STOCK } from "../../advice.js?v=20260831b";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260831b";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260831b";
import { подпись as подписьКол, единица, вЕдинице } from "../../unit.js?v=20260831b";
