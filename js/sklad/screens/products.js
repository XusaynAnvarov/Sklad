...
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260821l";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260821l";
import { fmt, convert } from "../../fx.js?v=20260821l";
import { thumb } from "../../img.js?v=20260821l";
import { LOW_STOCK } from "../../advice.js?v=20260821l";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260821l";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260821l";
