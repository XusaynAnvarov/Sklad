...
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260822c";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260822c";
import { fmt, convert } from "../../fx.js?v=20260822c";
import { thumb } from "../../img.js?v=20260822c";
import { LOW_STOCK } from "../../advice.js?v=20260822c";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260822c";
import { qrSvg, skuPayload } from "../../qr.js?v=20260822c";
import { setStock } from "../stock.js?v=20260822c";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260822c";
