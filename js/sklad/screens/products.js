...
import { el, go } from "../app.js?v=20260901c";
import { icon } from "../../icons.js?v=20260901c";
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260901c";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260901c";
import { fmt, convert } from "../../fx.js?v=20260901c";
import { thumb } from "../../img.js?v=20260901c";
import { LOW_STOCK } from "../../advice.js?v=20260901c";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260901c";
import { qrSvg, skuPayload } from "../../qr.js?v=20260901c";
import { setStock } from "../stock.js?v=20260901c";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260901c";
import { подпись as подписьКол, единица, вЕдинице } from "../../unit.js?v=20260901c";
