...
import { el, go } from "../app.js?v=20260915a";
import { icon } from "../../icons.js?v=20260915a";
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260915a";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260915a";
import { fmt, convert } from "../../fx.js?v=20260915a";
import { thumb } from "../../img.js?v=20260915a";
import { LOW_STOCK } from "../../advice.js?v=20260915a";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260915a";
import { qrSvg, skuPayload } from "../../qr.js?v=20260915a";
import { setStock } from "../stock.js?v=20260915a";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260915a";
import { подпись as подписьКол, единица, вЕдинице } from "../../unit.js?v=20260915a";
import { подходит } from "../../productsearch.js?v=20260915a";
import { подписьКода, естьКолонкаКода, кодПриСохранении, следующийПосле, КОД_ЗАНЯТ } from "../../catalogcode.js?v=20260915a";
