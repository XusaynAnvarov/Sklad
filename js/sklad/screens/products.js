...
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260910a";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260910a";
import { fmt, convert } from "../../fx.js?v=20260910a";
import { thumb } from "../../img.js?v=20260910a";
import { LOW_STOCK } from "../../advice.js?v=20260910a";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260910a";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260910a";
import { подпись as подписьКол, единица, вЕдинице } from "../../unit.js?v=20260910a";
