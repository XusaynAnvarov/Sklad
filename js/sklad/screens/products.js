...
import { toast, modal, confirmDialog, lightbox } from "../../ui.js?v=20260826a";
import { ensureBatches, currentCost, costOutlook } from "../../inventory.js?v=20260826a";
import { fmt, convert } from "../../fx.js?v=20260826a";
import { thumb } from "../../img.js?v=20260826a";
import { LOW_STOCK } from "../../advice.js?v=20260826a";
import { scanSku, resolveScan, scanFailText } from "../qr.js?v=20260826a";
...
import { костВалюта, костЧисло, костСтрока, костПоля, ВАЛЮТЫ } from "../../cost.js?v=20260826a";
