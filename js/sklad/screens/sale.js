...
import { toast, confirmDialog, modal } from "../../ui.js?v=20260821h";
import { fmt } from "../../fx.js?v=20260821h";
import { LOW_STOCK } from "../../advice.js?v=20260821h";
import { issueInvoice } from "../issue.js?v=20260821h";
import { scanSku, canScan, resolveScan, scanFailText } from "../qr.js?v=20260821h";
import { invoiceHtml, openPrint } from "../print.js?v=20260821h";
import { qrSvg, skuPayload } from "../../qr.js?v=20260821h";
import { setStock } from "../stock.js?v=20260821h";
import { freshFirst, lastAnyMap, lastForCustomerMap, suggestPrice, priceNote, repriceItems } from "../../prices.js?v=20260821h";
import { photoBlock } from "../photo.js?v=20260821h";
