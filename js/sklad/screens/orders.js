...
import { issueInvoice, totalsByCur } from "../issue.js?v=20260821f";
import { freshFirst, lastAnyMap, lastForCustomerMap, suggestPrice, priceNote } from "../../prices.js?v=20260821f";
